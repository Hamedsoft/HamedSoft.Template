...
(function (factory) {
    ...
    function _time2int(timeString, settings) {
        ...
        timeString = timeString.replace(/[۰-۹]/g, function (digit) { return String(digit.charCodeAt(0) - 1776); }).replace(/[٠-٩]/g, function (digit) {
        ...
        var ampmRegex =
            "(" +
            _lang.dawn.trim().replace(".", "") +
            "|" +
            _lang.am.trim().replace(".", "") +
            "|" +
            _lang.pm.trim().replace(".", "") +
            "|" +
            _lang.AM.trim().replace(".", "") +
            "|" +
            _lang.PM.trim().replace(".", "") +
            "|" +
            _lang.night.trim().replace(".", "") +
            ")?";
